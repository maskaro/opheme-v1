<?php
	...
	if (!isset($_SESSION['user']['reseller']) || intval($_SESSION['user']['reseller']) !== 1) {
...
<html>
	<head>
		<title><?php echo brand; ?> | Reseller</title>
		<!-- CSS -->
				...
				<div class="span12">
					<div id="account-container">
						...
						<div class="row-fluid" style="max-height: 500px; overflow: auto">
							<?php $opheme->system_admin_tokensGetAll(true); ?>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row-fluid">
				<div class="span12">
					<div id="account-container">
						...
						<div class="row-fluid" style="max-height: 500px; overflow: auto">
							<?php $opheme->system_admin_clientsGetAllOverview(true); ?>
						</div>
					</div>
				</div>
			</div>
