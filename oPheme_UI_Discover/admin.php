	...
	<body>
		...
		<div id="dashboard" class="container account">
			...
			<!--<div class="row-fluid">
				<div class="span12">
					<div id="account-container">
						<h4>oPheme Backend PHP Log (from running Module jobs) - last 50 lines - should contain info on what each module is currently doing and any massive errors that might occurs</h4>
						<div class="row-fluid" style="max-height: 500px; overflow: auto">
